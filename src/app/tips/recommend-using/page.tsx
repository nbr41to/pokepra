...
export default function Page() {
  return (
    <div className="mx-auto flex min-h-dvh max-w-3xl flex-col gap-6 px-6 py-10">
      ...
      />
      <div className="space-y-4 text-slate-700 text-sm dark:text-slate-200">
        <div className="space-y-2 rounded-2xl border border-black/10 bg-white/80 p-6 shadow-sm backdrop-blur dark:border-white/10 dark:bg-slate-900/70">
        ...
        <div className="space-y-2 rounded-2xl border border-black/10 bg-white/80 p-6 shadow-sm backdrop-blur dark:border-white/10 dark:bg-slate-900/70">
          ...
          <p>はじめの一歩はモンテカルロ法の説明と体験のページから。</p>
          <Link
