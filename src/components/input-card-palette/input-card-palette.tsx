    ...
    >
      {type === "A" && (
        <div className="grid grid-cols-5 gap-1">
          ...
          {CARD_RANKS.slice(8, 11).map((rank) => (
            <InputRankButton
              key={rank}
              rank={rank}
              disabled={
          ...
          {CARD_RANKS.slice(11, 13).map((rank) => (
            <InputRankButton
              key={rank}
              rank={rank}
              disabled={
